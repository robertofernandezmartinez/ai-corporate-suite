...
class StockoutPredictor:
    ...
    async def predict_from_file(self, file):
        ...
        try:
            ...
            price = pd.to_numeric(df_raw.get("Price", 0), errors="coerce").fillna(0)
            velocity = pd.to_numeric(df_raw.get("Units Sold", 0), errors="coerce").fillna(0)
